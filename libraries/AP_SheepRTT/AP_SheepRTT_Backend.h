...
#include <AP_SheepRTT/AP_SheepRTT.h>

class AP_SheepRTT_Backend {
public:
    AP_SheepRTT_Backend(struct AP_SheepRTT::Backend_Config &_config) :
        config(_config) { }

    // initialise the sheepRTT backend
    void init();
    ...
    virtual void init_sheepRTT() = 0;

    // type-specific periodic updates:
    virtual void update_sheepRTT() { };

protected:

    struct AP_SheepRTT::Backend_Config &config;
};
